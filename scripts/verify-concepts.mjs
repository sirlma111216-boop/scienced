 ...
 *
 * 개념 카드 (4.4):
 *   · what 3~6문장 · why 2~4문장 · inClass 3~9문장 — 문단 하나씩 (2026-09-22 위를 늘림)
...
/* 2026-09-22 「교실에서」의 위를 9문장으로 늘렸다 — 상황·일어난 일·결과·왜 이 개념의 예인지가 다 들어가야 한다 (강의자 지적: 줄여 쓴다고 명쾌해지지 않는다) */
const RANGE = { what: [3, 6], why: [2, 4], inClass: [3, 9] }
