  ...
  entries: [
    {
      ...
      bridgeToPlain:
        '이 카드의 「무엇」에서 「관찰도 이론의 영향을 받지만」이라고 한 것이 이 주장이다. ' +
        '그다음에 「측정 기준과 여러 사람의 대조로 그 영향을 드러내고 줄일 수 있다」고 한 것은 이론의존성이 곧 상대주의는 아니라는 한계 쪽 대답이다.',
      limits:
    ...
    },
    {
      ...
      bridgeToPlain:
        '이 카드 전체가 이 구분이다. 「무엇」의 「눈으로 확인한 것과, 그것을 보고 머릿속에서 채운 것」이 관찰과 추론이고, 도입의 발자국 사진은 Lederman 이 이 구분을 가르칠 때 쓰는 고전적 과제를 그대로 옮긴 것이다.',
      limits:
    ...
    },
    {
      ...
      bridgeToPlain:
        '이 카드의 「무엇」에서 자료·증거·추론을 셋으로 가른 것과, 「왜」의 「어느 자료를 왜 골랐는지」 묻는 자리가 이 틀이다. ' +
    ...
    },
    {
      ...
      bridgeToPlain:
        '이 카드의 「무엇」에서 「새 증거로 고칠 수 있다는 것이 지금 믿을 수 없다는 뜻은 아니다」라고 한 것의 앞 절 — 고칠 수 있음 — 이 Popper 의 잠정성이다. ' +
        '학생 보고서의 「이 실험 한 번으로 가설이 증명되었다」를 짚는 일도 여기서 온다. 증명은 애초에 되지 않는다.',
      limits:
    ...
    },
    {
      ...
      bridgeToPlain:
        '이 카드의 「무엇」에서 「공동체의 비판을 거쳤기 때문에」라고 한 것이 Kuhn 의 공동체이고, 「기준」의 「과학이 아무 때나 뒤집히지 않는다」가 정상과학과 혁명의 구분에서 온다. ' +
    ...
    },
    {
      ...
      bridgeToPlain:
        '이 카드의 「무엇」에서 「세부 수치는 자주, 모형은 가끔, 핵심 이론은 드물게」 바뀐다고 한 층이 Lakatos 의 자리다. 핵은 쉽게 바뀌지 않고(신뢰성), 보호대는 늘 고쳐진다(잠정성). ' +
      ...
      linkedConceptId: 'c02-tentative',
      plainTerms: ['세부 수치는 자주, 모형은 가끔, 핵심 이론은 드물게'],
    ...
    },
    {
      ...
      bridgeToPlain:
        ...
        '카드 3 의 「더 읽기」에서 「과학의 본성을 명시적·성찰적으로」 다룬다고 한 것이 이 관점의 핵심 처방이다.',
      limits:
    ...
    },
    {
      ...
      bridgeToPlain:
        '이 카드의 「무엇」에서 「어떤 질문에 답하려고 고른 설명 도구」라고 한 것이 이 입장이다. ' +
        '「왜」의 「실제와 다르니 틀린 모형」이 이 입장이 고치려는 학생의 생각이다. 모형 만들기 자체는 나중에 따로 배운다.',
      limits:
