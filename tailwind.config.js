  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        /* 2026-09-22 한 단계 키웠다 — 프로젝터 뒤에서 읽히지 않았다 (강의자 지적). 본문 18→20 · 작은 본문 16→18 · 제목 26→30 · 카드 제목 24→26 · 캡션 12→13 */
        headline: ['30px', { lineHeight: '1.3', letterSpacing: '-0.3px', fontWeight: '560' }],
        subhead: ['30px', { lineHeight: '1.3', letterSpacing: '-0.3px', fontWeight: '340' }],
        'card-title': ['26px', { lineHeight: '1.4', letterSpacing: '0px', fontWeight: '700' }],
        'body-lg': ['22px', { lineHeight: '1.4', letterSpacing: '-0.14px', fontWeight: '340' }],
        body: ['20px', { lineHeight: '1.45', letterSpacing: '-0.2px', fontWeight: '340' }],
        'body-sm': ['18px', { lineHeight: '1.45', letterSpacing: '-0.14px', fontWeight: '340' }],
        ...
        caption: ['13px', { lineHeight: '1.2', letterSpacing: '0.5px', fontWeight: '450' }],
      },
